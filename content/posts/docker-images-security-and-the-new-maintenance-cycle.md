...
date: 2016-04-01T08:27:04-0400
comments: true
tags: ["docker", "travis", "testing", "ci", "security"]
---
Container management and development of a process towards keeping Docker images secure may seem like a daunting task, especially at scale. Stale images lead to [security vulnerablities](http://thenewstack.io/docker-launches-vulnerability-scanner-containers/), and this is a very real concern when administrators can [let containers run for weeks at a time without updates](https://www.datadoghq.com/docker-adoption/).
...
Most CI services offer cron based triggering. Travis provides repository [cronjobs](https://docs.travis-ci.com/user/cron-jobs/) upon request. Triggering a nightly rebuild and test will pull in security fixes automatically, and re-test the image using those new changes.
