...
date: 2016-11-10T08:27:04-04:00
comments: true
tags: ["drupal", "search_api_solr", "solr"]
---
...
However, I believe that **users who type _exact_ node titles into search boxes would generally expect to see those first in a result set, followed by those that match _somewhat_, and then _less-and-less_**.

## The Goal
To obtain this, we require solr to return a result set where:
